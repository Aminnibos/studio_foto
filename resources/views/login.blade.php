...
<body class="bg-[#FFFCF5] font-sans flex h-screen overflow-hidden">
    ...
    <div class="w-full md:w-1/2 flex items-center justify-center p-8 bg-[#FFFCF5]">
        <div class="w-full max-w-md space-y-8">
            
            <div class="text-center md:text-left">
                <h2 class="text-3xl font-black text-[#1F2937] tracking-tight">Selamat Datang!</h2>
                <p class="text-[11px] text-gray-500 mt-2">Silakan masuk ke akun Anda untuk melanjutkan</p>
            </div>
            ...
            <form action="/login" method="POST" class="space-y-5">
                ...
                <div>
                    <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1.5">Alamat Email</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <i class="fa-regular fa-envelope text-gray-400 text-sm"></i>
                        </div>
                        <input type="email" name="email" class="w-full pl-9 pr-4 py-3 bg-blue-50/40 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#C1BA8A]/50 focus:border-[#C1BA8A] transition-colors" placeholder="email@contoh.com" required>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" class="w-full pl-9 pr-4 py-3 bg-blue-50/40 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#C1BA8A]/50 focus:border-[#C1BA8A] transition-colors" placeholder="••••••••" required>
                    </div>
                </div>

                <div class="flex items-center justify-between mt-2">
                    <label class="flex items-center space-x-2 cursor-pointer">
                        <input type="checkbox" class="rounded text-[#C1BA8A] focus:ring-[#C1BA8A] w-3.5 h-3.5 border-gray-300">
                        <span class="text-[10px] text-gray-500 font-medium">Ingat Saya</span>
                    </label>
                    <a href="#" class="text-[10px] text-[#A69E65] font-bold hover:underline">Lupa Sandi?</a>
                </div>
            ...
            <div class="text-center mt-8">
                <p class="text-[10px] text-gray-500 font-medium">Belum punya akun? <a href="/register" class="text-[#A69E65] font-bold hover:underline">Daftar di sini</a></p>
            </div>
