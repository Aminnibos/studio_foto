...
<head>
    ...
    <title>Admin Login - Graphic Photostudio</title>
...
<body class="bg-[#FFFCF5] font-sans flex h-screen overflow-hidden">
    ...
    <div class="relative hidden md:flex w-1/2 bg-black items-center justify-center">
        ...
        <div class="relative z-10 p-12 w-full text-left">
            ...
            <p class="text-gray-200 text-sm max-w-sm leading-relaxed drop-shadow-md">Panel Manajemen Studio. Kelola pesanan, paket, dan laporan dengan mudah dan terstruktur.</p>
        </div>
    </div>
    ...
    <div class="w-full md:w-1/2 flex flex-col items-center justify-center p-8 bg-[#FFFCF5] relative">
        ...
        <div class="w-full max-w-md space-y-8 mt-6 md:mt-0">
            ...
            <div class="text-center md:text-left flex flex-col items-center md:items-start">
                ...
                <h2 class="text-3xl font-black text-[#1F2937] tracking-tight">Admin Login</h2>
                <p class="text-[11px] text-gray-500 mt-2">Masukkan kredensial Anda untuk mengakses sistem</p>
            </div>
            ...
            <form action="/login" method="POST" class="space-y-5">
                ...
                <div>
                    <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1.5">Username / Email Admin</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <i class="fa-regular fa-user text-gray-400 text-sm"></i>
                        </div>
                        <input type="text" name="email" class="w-full pl-9 pr-4 py-3 bg-blue-50/40 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#C1BA8A]/50 focus:border-[#C1BA8A] transition-colors" placeholder="Ketik username atau email" required>
                    </div>
                </div>
            ...
            <div class="text-center mt-8">
                <p class="text-[10px] text-gray-500 font-medium">Belum punya akun admin? <span class="text-[#A69E65] font-bold">Hubungi pemilik studio.</span></p>
            </div>
